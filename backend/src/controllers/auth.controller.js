...
export const signup = async (req, res) => {
  ...
  try {
    ...
    const isDbError = error.name === "MongooseServerSelectionError" || error.name === "MongoServerError" || error.message.includes("buffering timed out");
    const message = isDbError 
      ? "Database connection failed. Please check MONGODB_URI and your database password in backend/.env" 
